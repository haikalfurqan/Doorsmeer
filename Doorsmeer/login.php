<?php
    //session_start();
    if(!empty($_SESSION['username_doorsmeer'])){
...
<head>
    ...
    <title>Dorsmeer-aplikasi doorsmeer</title>
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form class="needs-validation text-center" novalidate action="proses/proses_login.php" method="POST">
